...
export default function ClientQuotes() {
  ...
  return (
    <div className="p-4 md:p-6 space-y-6 max-w-7xl mx-auto">
      <div>
        <h1 className="text-3xl font-bold" data-testid="text-client-quotes-title">Mes Devis</h1>
        <p className="text-muted-foreground mt-1">Consultez et téléchargez vos devis</p>
      </div>
